...
program
  ...
  .option('-w, --width <number>', 'Target width in pixels', (val) => parseInt(val, 10))
  .option('-h, --height <number>', 'Target height in pixels', (val) => parseInt(val, 10))
  .option('-o, --output <path>', 'Output image file path')
  .option('-f, --format <format>', 'Output format (jpeg, png, webp, tiff, avif)')
  .option('-q, --quality <number>', 'Quality (1-100)', (val) => parseInt(val, 10), 80)
